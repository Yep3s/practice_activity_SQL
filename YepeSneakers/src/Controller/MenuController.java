...
public class MenuController {
    ...
    void actualizarSneakerBtn(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/ActualizarSneaker.fxml"));
    ...
    void eliminarSneakerBtn(ActionEvent event) {
        ...
        try {
            // Cargar el archivo FXML de la segunda vista
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/View/EliminarSneaker.fxml"));
            Parent root = loader.load();
